...
//   return (
//     <div
//       className={`min-h-screen flex ${dark ? "bg-slate-950 text-slate-100" : "bg-white text-slate-900"
//         }`}
//     >
//       {/* ================= SIDEBAR ================= */}
//       <aside
...
//         <header
//           className={`flex items-center justify-between px-6 py-4 border-b ${dark
...
//             className={`px-3 py-1 text-sm rounded border ${dark
//                 ? "border-slate-600 hover:bg-slate-700"
//                 : "border-gray-300 hover:bg-gray-100"
//               }`}
//           >
